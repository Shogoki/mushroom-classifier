...
export class MushroomService {
     ...
     */
    public getHistory(last?: number, observe?: 'body', reportProgress?: boolean): Observable<Array<Mushroom>>;
    public getHistory(last?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Mushroom>>>;
    public getHistory(last?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Mushroom>>>;
    public getHistory(last?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Mushroom>>(`${this.configuration.basePath}/mushrooms`,
            {
